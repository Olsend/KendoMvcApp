...
namespace KendoMvcApp.Controllers
{
    ...
    builder.EntitySet<Employee>("EmployeesAPI");
    config.Routes.MapODataServiceRoute("odata", "odata", builder.GetEdmModel());
    */
    public class EmployeesAPIController : ODataController
    {
        private EmployeeEntities db = new EmployeeEntities();

        // GET: odata/EmployeesAPI
        [EnableQuery]
        public IQueryable<Employee> GetEmployeesAPI()
        {
            return db.Employees;
        }

        // GET: odata/EmployeesAPI(5)
        [EnableQuery]
